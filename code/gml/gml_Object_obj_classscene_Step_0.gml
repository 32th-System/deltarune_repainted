if (global.chapter == 1)
{
    ...
    if (con == 35)
    {
        ...
        global.msg[4] = stringsetloc("\\E6* Ummm^1, Postal Dude^1, you're with Kris!/", "obj_classscene_slash_Step_0_gml_211_0")
        scr_susface(5, 0)
    ...
    if (con == 51)
    {
        ...
        global.msg[5] = stringsetloc("\\Ta\\Fa\\E6* G-good idea^1, Noelle^1!&* Postal Dude^1, s-since you came in last.../", "obj_classscene_slash_Step_0_gml_304_0")
    ...
    if (con == 51.4)
    {
        ...
        global.msg[2] = stringsetloc("\\E0* Miss Alphys^1, why don't Postal Dude and I.../", "obj_classscene_slash_Step_0_gml_342_0")
        global.msg[3] = stringsetloc("\\Ta\\Fa\\E6* G-good idea^1, Noelle^1!&* Postal Dude^1, s-since you came in last.../", "obj_classscene_slash_Step_0_gml_343_0")
...
if (global.chapter == 2)
{
    ...
    {
        scr_speaker("alphys")
        msgsetloc(0, "\\E0* Scott, you sussy baka^1, there you are!/", "obj_classscene_slash_Step_0_gml_493_0")
        msgnextloc("\\EA* (Even Postal Dude showed up before you^1, eheh...)/%", "obj_classscene_slash_Step_0_gml_494_0")
        alttalk = 0
    ...
    if (con == 10 && instance_exists(obj_dialoguer) == 0)
    {
        ...
        c_msgside("top")
        c_speaker("susie")
        c_msgsetloc(0, "\\E2* (Hey^1, Scott!)/", "obj_classscene_slash_Step_0_gml_566_0")
        ...
        c_msgside("bottom")
        c_speaker("alphys")
        c_msgsetloc(0, "\\E9* Postal Dude^1, please don't kick your desk./", "obj_classscene_slash_Step_0_gml_574_0")
        c_msgnextloc("\\E4* Treat school property^1, like you'd treat your wife./%", "obj_classscene_slash_Step_0_gml_575_0")
        c_talk_wait()
        c_msgside("top")
        c_speaker("susie")
        c_msgsetloc(0, "\\E0* ..../", "obj_classscene_slash_Step_0_gml_579_0")
        c_msgnextloc("\\E1* Okay./", "obj_classscene_slash_Step_0_gml_580_0")
        c_msgnextloc("\\E2* Next time I'll set It on fire./%", "obj_classscene_slash_Step_0_gml_581_0")
        c_talk_wait()
        ...
        c_msgnextloc("\\E6* First^1, we're starting from Five Nights At Freddy’s 4 Episode 5!/", "obj_classscene_slash_Step_0_gml_608_0")
        c_msgnextloc("\\E4* Any..^1. any Markipliers?/%", "obj_classscene_slash_Step_0_gml_609_0")
        c_talk_wait()
        c_wait(30)
        c_sel(no)
        c_specialsprite(0)
        ...
        c_facing("d")
        c_speaker("berdly")
        c_msgsetloc(0, "\\E1* Ah^1, Shut up^1, Noelle!/", "obj_classscene_slash_Step_0_gml_626_0")
        c_msgnextloc("\\E2* Do i need to remind you who Is the gamer here?!!/", "obj_classscene_slash_Step_0_gml_627_0")
        c_facenext("noelle", 3)
        c_msgnextloc("\\E3* Umm^1, no no^1, don't do that…/%", "obj_classscene_slash_Step_0_gml_629_0")
        c_talk()
        c_wait(10)
        c_waittalk()
        c_sel(be)
        ...
        c_msgnextloc("\\E1* \"Five Nights at Freddy’s 4 Episode 5 9:11\"/", "obj_classscene_slash_Step_0_gml_644_0")
        c_msgnextloc("\\E3* \"Hey guys^1, I think the little man said he wants to give Fredbear a big kiss!^1\"/", "obj_classscene_slash_Step_0_gml_645_0")
        c_msgnextloc("\\E4* \"ON THREE! One…Two…\"/", "obj_classscene_slash_Step_0_gml_646_0")
        c_msgnextloc("\\E2* \"…WAS THAT THE BITE OF 87?!?\"/%", "obj_classscene_slash_Step_0_gml_647_0")
        c_talk_wait()
        c_mus2("volume", 0, 60)
        c_fadeout(60)
        c_speaker("none")
        c_wait(30)
        c_msgsetloc(0, "* The FNAF lore is too dense for you…/%", "obj_classscene_slash_Step_0_gml_653_0")
        c_talk()
        c_wait(30)
        c_waittalk()
        c_mus("free")
    ...
    if (con == 17)
    {
        ...
        {
            scr_speaker("alphys")
            msgnextloc("\\E3* ... Kris..^1. Where did you and Postal Dude go yesterday?/", "obj_classscene_slash_Step_0_gml_747_0")
            ...
            msgnextloc("\\E6* If... If Postal Dude causes you any trouble^1, then.../", "obj_classscene_slash_Step_0_gml_752_0")
