...
if draw_screen
{
    ...
    if (con == 6)
    {
        ...
        if (contimer == 551)
        {
            ...
            w = instance_create_ch1(50, 185, obj_writer_ch1)
            contimer = 0
            c_chunkamt = 0
            chunkfade = 0
            con = 7
    ...
    if (con == 8)
    {
        ...
        if (contimer == 69)
        {
            ...
            w = instance_create_ch1(95, 185, obj_writer_ch1)
        }
        if (contimer == 138)
        {
            global.msg[0] = scr_84_get_lang_string_ch1("obj_legend_slash_Draw_0_gml_317_0")
            w = instance_create_ch1(220, 185, obj_writer_ch1)
        }
    ...
    if (con == 10)
    {
        ...
        if (contimer == 640)
        {
            ...
            w = instance_create_ch1(50, 160, obj_writer_ch1)
        }
        if (contimer >= 444)
        {
            xtimer += 1
