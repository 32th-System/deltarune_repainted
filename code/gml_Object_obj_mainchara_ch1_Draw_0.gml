...
if (battlemode == 1)
{
    ...
    if (battlealpha < 0.8)
        battlealpha += 0.04
    global.heartx = (battleheart.x - __view_get(0, 0))
    global.hearty = (battleheart.y - __view_get(1, 0))
}
...
draw_sprite_ext(spr_heart_outline2_ch1, 0, battleheart.x, battleheart.y, 1, 1, 0, c_white, (battlealpha * 2))
if (battlemode == 4) // Unused
{
