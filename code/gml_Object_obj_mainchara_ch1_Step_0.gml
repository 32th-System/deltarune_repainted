...
if (global.interact == 0)
{
    ...
    if global.darkzone
        x_ += 4
    y_ = (y + 2)
    if place_meeting((x_ + px), y_, obj_solidblock_ch1)
    {
        var g = wspeed
        while (g > 0)
        {
            var mvd = 0
            if (press_d == 0 && (!(place_meeting((x_ + px), (y_ - g), obj_solidblock_ch1))))
            {
                y -= g
                py = 0
                break
            ...
            {
                mvd = 1
                if (press_u == 0 && mvd == 0 && (!(place_meeting((x_ + px), (y_ + g), obj_solidblock_ch1))))
                {
                    y += g
                    py = 0
                    break
        ...
        if (px > 0)
        {
            ...
            while (i >= 0)
            {
                if (!(place_meeting((x_ + i), y_, obj_solidblock_ch1)))
                {
                    px = i
                    bkx = 1
                    break
    ...
    else if place_meeting(x_, (y_ + py), obj_solidblock_ch1)
    {
        ymeet = 1
        bky = 0
        g = wspeed
        ...
        {
            mvd = 0
            if (press_r == 0 && (!(place_meeting((x_ - g), (y_ + py), obj_solidblock_ch1))))
            {
                x -= g
                px = 0
                break
            ...
            {
                mvd = 1
                if (mvd == 0 && press_l == 0 && (!(place_meeting((x_ + g), (y_ + py), obj_solidblock_ch1))))
                {
                    x += g
                    px = 0
                    break
        ...
        if (py > 0)
        {
            ...
            while (i >= 0)
            {
                if (!(place_meeting(x_, (y_ + i), obj_solidblock_ch1)))
                {
                    py = i
                    bky = 1
                    break
    ...
    if place_meeting((x_ + px), (y_ + py), obj_solidblock_ch1)
    {
        xymeet = 1
        bkxy = 0
        i = px
        ...
        while (j != 0 || i != 0)
        {
            if (!(place_meeting((x_ + i), (y_ + j), obj_solidblock_ch1)))
            {
                px = i
                py = j
                bkxy = 1
